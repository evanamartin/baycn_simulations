...
emse_m1_cp_5_200 <- emse(pp1 = bay_m1_cp_5_200_02,
                         pp2 = bay_m1_cp_5_200_05,
                         pp3 = bay_m1_cp_5_200_1,
                         ep = ep_m1_cp_5,
                         M = M)
...
kable(format = 'latex',
      ...
      cbind(c('common', 'parent', '', '', '', '', '', '', '', '', '', ''),
            c('200', '', '', '', '', '', '', '', '', '', '', ''),
            1:12,
            round(emse_m1_cp_5_200, 4)))

emse_m1_cp_5_500 <- emse(pp1 = bay_m1_cp_5_500_02,
                         pp2 = bay_m1_cp_5_500_05,
                         pp3 = bay_m1_cp_5_500_1,
                         ep = ep_m1_cp_5,
                         M = M)
...
emse_m1_cc_5_200 <- emse(pp1 = bay_m1_cc_5_200_02,
                         pp2 = bay_m1_cc_5_200_05,
                         pp3 = bay_m1_cc_5_200_1,
                         ep = ep_m1_cc_5,
                         M = M)
...
kable(format = 'latex',
      ...
      cbind(c('common', 'child', '', '', '', '', '', '', '', '', '', ''),
            c('200', '', '', '', '', '', '', '', '', '', '', ''),
            1:12,
            round(emse_m1_cc_5_200, 4)))

emse_m1_cc_5_500 <- emse(pp1 = bay_m1_cc_5_500_02,
                         pp2 = bay_m1_cc_5_500_05,
                         pp3 = bay_m1_cc_5_500_1,
                         ep = ep_m1_cc_5,
                         M = M)
...
emse_m1_iv_5_200 <- emse(pp1 = bay_m1_iv_5_200_02,
                         pp2 = bay_m1_iv_5_200_05,
                         pp3 = bay_m1_iv_5_200_1,
                         ep = ep_m1_iv_5,
                         M = M)
...
kable(format = 'latex',
      ...
      cbind(c('intermediate', '', '', '', '', '', '', '', '', '', '', ''),
            c('200', '', '', '', '', '', '', '', '', '', '', ''),
            1:12,
            round(emse_m1_iv_5_200, 4)))

emse_m1_iv_5_500 <- emse(pp1 = bay_m1_iv_5_500_02,
                         pp2 = bay_m1_iv_5_500_05,
                         pp3 = bay_m1_iv_5_500_1,
                         ep = ep_m1_iv_5,
                         M = M)
